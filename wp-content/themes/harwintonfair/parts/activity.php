...
$date      = ( in_array( '0_end', $meta ) )
	? date( 'l, F jS', strtotime( $meta['0_begin'][0] ) ) . ' bar at ' . date( 'g:i A', strtotime( $meta['0_begin'][0] ) ) . ' - ' . date( 'g:i A', strtotime( $meta['0_end'][0] ) )
	: date( 'l, F jS', strtotime( $meta['0_begin'][0] ) ) . ' foo at ' . date( 'g:i A', strtotime( $meta['0_begin'][0] ) );
?>
...
<?php endif; ?>
<?php if ( ! is_single() ) : ?>
	<?php get_template_part( 'parts/activity-list-item' ); ?>
<?php endif; ?>
